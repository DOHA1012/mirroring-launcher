...
👉 **[미러링 바로연결 Standalone Package 다운로드 (ZIP)](https://github.com/DOHA1012/pokemon-champions-pc/releases/download/v1.0.0/Pokemon_Champions_PC.zip)**
...
👉 **[Download Universal Mirroring Launcher Standalone Package (ZIP)](https://github.com/DOHA1012/pokemon-champions-pc/releases/download/v1.0.0/Pokemon_Champions_PC.zip)**
